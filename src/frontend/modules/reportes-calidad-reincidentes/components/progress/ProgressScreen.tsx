...
export const ProgressScreen: React.FC<ProgressScreenProps> = ({ progress, message }) => {
  const safeProgress = Math.max(0, Math.min(100, Math.round(progress)));

  return (
    <div className={`${styles.screen} ${styles.rriTone}`}>
      <div className={styles.card}>
        <div className={styles.brand}>
          <div className={styles.brandCopy}>
            <span className={styles.eyebrow}>GroupCOS</span>
            <strong className={styles.brandName}>Reporte de Reincidencia</strong>
          </div>
        ...
        <div className={styles.progress}>
          ...
          <div className={styles.bar} role="progressbar" aria-valuemin={0} aria-valuemax={100} aria-valuenow={safeProgress} aria-label="Cargando reporte de reincidencia">
